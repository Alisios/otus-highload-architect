...
class ChatController(private val chatService: ChatService) {
    ...
    ) = chatService.sendMessage(userMessageDto, SecurityContextHolder.getContext().authentication.name)
    ...
    fun getByUserId(): List<FriendChat> =
        chatService.getAllChats(SecurityContextHolder.getContext().authentication.name)
    ...
    fun getChatByChatId(@PathVariable("chatId") chatId: String): MutableList<MessageDto> =
        chatService.getChatByChatId(SecurityContextHolder.getContext().authentication.name, chatId)
