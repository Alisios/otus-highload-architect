...
data class NewUserDto(
  ...
  //  @field:Size(min = 5, max = 50, message = "Длина логина должна быть от 5 до 50 символов")
  ...
  //  @field:Size(min = 8, max = 50, message = "Длина пароля должна быть от 8 до 50 символов")
    //@Pattern(regexp = LOGIN_PATTERN, message = "Логин может состоять из букв английского алфавита и цифр")
    val password: String,
