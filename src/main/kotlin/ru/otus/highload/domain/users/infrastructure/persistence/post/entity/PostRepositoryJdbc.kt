...
import ru.otus.highload.domain.users.infrastructure.persistence.post.PostRepository
...
class PostRepositoryJdbc(
    ...
    override fun findByUserId(userId: String): List<PostEntity> {
    ...
    override fun getFeed(userId: String, offset: Long, limit: Long): List<PostEntity> {
        return namedParameterJdbcOperations.query(
